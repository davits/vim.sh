...
hi Error		ctermfg=252		ctermbg=124		cterm=none		guifg=#d0d0d0   guibg=#d70000	gui=none
...
hi Todo			ctermfg=160		ctermbg=241		cterm=none		guifg=#d70000	guibg=#636066	gui=italic
